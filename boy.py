...
class Boy:
    ...
    def draw(self):
        ...
        draw_rectangle(*self.get_bb())  #하나의 튜플을 넘겨주기(*)
    ...
    def get_bb(self):
        # fill here
        # 네 개의 값, x1, y1, x2, y2
        return self.x-20, self.y-50, self.x+20, self.y+50   #네 개의 값으로 구성된 하나의 튜플
        pass

    def handle_collision(self, group, other):
        # fill here
        if group == 'boy:ball':
            self.ball_count += 1    #제거는 공 스스로 하는 게 좋음
